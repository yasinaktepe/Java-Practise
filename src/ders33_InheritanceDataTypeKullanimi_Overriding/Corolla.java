...
public class Corolla extends BToyota{
    ...
    public static void main(String[] args) {
        ...
        aynı class dan ise bir variable in degerini bulmak icin
        o class a gideriz. O class da yoksa sirasiyla parent
        class lara bakilir. Ilk bulunan kullanilir.
         */
        ...
        varsa kullanilir. yoksa o class in parentlarina bakilir
        ...
        System.out.println(toyota3.yakit); //Araba
